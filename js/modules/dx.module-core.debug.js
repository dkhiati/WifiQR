    ...
    (function($, DX, undefined) {
        ...
        optionConfigurator.dxLoadIndicator = function(device) {
            var realDevice = DevExpress.devices.real,
                oldAndroid = realDevice.platform === "android" && (realDevice.version[0] < 4 || realDevice.version[0] === 4 && realDevice.version[1] === 0);
            if (DevExpress.browser.msie && DevExpress.browser.version[0] <= 10 || oldAndroid)
